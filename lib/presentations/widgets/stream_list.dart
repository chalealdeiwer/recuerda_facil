...
class StreamListWidget extends ConsumerStatefulWidget {
  final bool done;
  StreamListWidget({required this.done, super.key});
      ...
      return StreamBuilder<List>(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            ...
            final notes2 =
                notes!.where((element) => element.stateDone == true).toList();
                            ...
                            onChanged: (value) async {
                              if (notes2[index].stateDone == true) {
                                await noteProvider.updateNoteDateFinish(
                                    notes2[index].key, DateTime(1,1,1,0,0));
                              }
                      ...
                      onLongPress: () {
                        showDialog(
                            ...
                            builder: (BuildContext context) {
                              return AlertDialog(
                                title: const Text("Información Recordatorio"),
                                content: Container(
                                  height: 300,
                                  width: 500,
                                  child: Column(
      ...
      return StreamBuilder<List>(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            final notes = snapshot.data;
            final notes2 =
                notes!.where((element) => element.stateDone == false).toList();
                            ...
                            child: Transform.scale(
                              ...
                              child: Checkbox(
                                  ...
                                  onChanged: (value) async {
                                    ...
                                    if (notes2[index].stateDone == false) {
                                      await noteProvider.updateNoteDateFinish(
